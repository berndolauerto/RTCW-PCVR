...
extern gentity_t * weapon_grenadelauncher_fire_vr ( gentity_t * ent , int grenType ) ;
...
extern void convertFromVR ( float worldscale , gentity_t * ent , vec3_t in , vec3_t offset , vec3_t out ) ;
extern void rotateAboutOrigin ( float x , float y , float rotation , vec2_t out ) ;
...
extern int trap_Vibrate ( int duration , int channel , float intensity ) ;
...
extern int trap_Cvar_VariableValue ( const char * var_name , float * value ) ;
...
extern int SysMilliseconds ( void ) ;
